...
class MainDashboard(ctk.CTk):
    ...
    def _create_header(self):
        ...
        version_label = ctk.CTkLabel(
            left_frame,
            text="Professional Engineering Suite • Version 1.1",
            font=("Segoe UI", 13),
    ...
    def _create_main_content(self):
        ...
        instruction_label = ctk.CTkLabel(
            instruction_frame,
            text="Select a computational module to begin analysis:",
            font=("Segoe UI", 16),
            text_color=self.theme["text_secondary"]
        )
        ...
        modules = [
            {
                ...
                "chapter": "Chapter 1",
                "icon": "💧",
                "description": "Density, Viscosity, Surface Tension",
                "color": "#3b82f6",
            ...
            },
            {
                ...
                "chapter": "Chapter 2",
                "icon": "⚖️",
                "description": "Pressure, Buoyancy, Hydrostatics",
                "color": "#8b5cf6",
            ...
            },
            {
                ...
                "chapter": "Chapter 3",
                "icon": "🌀",
                "description": "Flow Analysis, Bernoulli, Energy",
                "color": "#10b981",
            ...
            },
            {
                ...
                "chapter": "Chapter 4",
                "icon": "📐",
                "description": "Similitude, Pi Theorem, Scaling",
                "color": "#f59e0b",
    ...
    def _create_module_card(self, parent, module_data):
        ...
        chapter_label = ctk.CTkLabel(
            top_frame,
            text=module_data["chapter"],
            font=("Segoe UI", 11, "bold"),
            text_color=module_data["color"]
        )
    ...
    def _create_footer(self):
        ...
        uni_label = ctk.CTkLabel(
            left_info,
            text="🎓 Amirkabir University of Technology • Civil Engineering",
            font=("Segoe UI", 11),
            text_color=self.theme["text_secondary"]
        )
